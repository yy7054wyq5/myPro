...
function params(o){ //閻忓繐妫滈々锔藉閻樼數鑸堕柛姘瑜版挳鎯冮崟顐㈡闁轰焦濯藉ù鍡涘礌閺嶏箒绀嬮悗娑欘殘椤戜焦绋夌拠褏绀夊ù鐘劚婵偤宕楅妷銉ョ厒url濞戞搫鎷�
	var arr = [];
	for(var i in o){
...
$.ajaxp = function(args){ //闁告帗绋戠紓鎼抍ript闁煎搫鍊婚崑锝夋晬鐏炶姤鍊婚柛姘瑜板鎷犻柨瀣勾js闁挎稑顔抮c闁煎搫鍊婚崑锝夊箹閸濆嫮鏁ㄩ柟瀛樺灩濞堟垿宕ｉ崒娑欐濞ｅ洠鍓濇导锟�
	var script = document.createElement("script");
	script.type="text/javascript";
	script.src = args.url + "?" + params(args.params);
	document.body.appendChild(script);
	var time = setTimeout(args.params.callback + "()", 6000); //閻犱礁澧介悿鍡欐惥閸涱喗顦ч柡鍐ㄧ埣濡潡鏁嶅畝鍐炬綍鐎电増銇炵粭澶嬩繆閵夈儱璁插ù鐘劜濞插潡寮ㄩ敓锟�
